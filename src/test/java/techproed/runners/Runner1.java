...
@CucumberOptions(
        plugin = {"pretty","html:src/test/resources/features/htmlReport/cucumberHooks1.html",
                "json:target/json-reports/cucumber1.json",
                "junit:src/test/resources/features/htmlReport/cucumber1.xml", // plugin ifadesi ile pretty ifadesi kullanılırsa konsolda scenario'lar ile ilgil ibilgi gösterir.
