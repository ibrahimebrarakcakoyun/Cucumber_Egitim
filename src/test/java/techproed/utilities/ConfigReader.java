...
public class ConfigReader {
    ...
    //Herşeyden önce çalışması için static blok içerisinde oluşturmuş olduğum properties dosyasını tanımlar ve atamasını
    //yaparız. FileInputStream ile dosya yolunu akışa alırız.
    ...
    public  static String getProperty(String Key){ //String bir değer döndürmesi için String bir parametre atarız.
        /*
        Test methodundan gönderdiğimiz string key değerini alıp ConfigReader Class'ından
